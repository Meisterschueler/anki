...
PEAKS = [
    ...
    POI("peak_18", "Hafelekar",                   "peak", 47.31278, 11.38639, 2334),
    POI("peak_19", "Brandjoch",                   "peak", 47.30224, 11.34154, 2559,
        subtitle="Vordere Brandjochspitze"),
    POI("peak_20", "Stanser Joch",                "peak", 47.39944, 11.69889, 2102),
    ...
    POI("peak_26", "Großglockner",                "peak", 47.07455, 12.69439, 3798),
    POI("peak_27", "Türchelkopf",                 "peak", 47.23864, 12.77799, 2134),
    POI("peak_28", "Großvenediger",               "peak", 47.10917, 12.34639, 3657),
    POI("peak_29", "Sandspitze",                  "peak", 46.76667, 12.81167, 2770),
    POI("peak_30", "Bischofsmütze",               "peak", 47.49389, 13.51111, 2458),
    POI("peak_31", "Rossbrand",                   "peak", 47.41528, 13.47889, 1770),
    POI("peak_32", "Dachstein",                   "peak", 47.47528, 13.60583, 2995),
    POI("peak_33", "Gscheuerwand",                 "peak", 47.72049, 12.43402, 1106),
    POI("peak_34", "Eiger",                        "peak", 46.57763,  8.00547, 3967),
    POI("peak_35", "Mönch",                        "peak", 46.55850,  7.99727, 4110),
    POI("peak_36", "Jungfrau",                     "peak", 46.53677,  7.96259, 4158),
    POI("peak_37", "Weißhorn",                     "peak", 46.10123,  7.71615, 4505),
    POI("peak_38", "Dom",                          "peak", 46.09393,  7.85887, 4545),
    POI("peak_39", "Oberrothorn",                  "peak", 46.02754,  7.81280, 3413),
    POI("peak_40", "Gornergrat",                   "peak", 45.98360,  7.78470, 3100),
    POI("peak_41", "Matterhorn",                   "peak", 45.97640,  7.65860, 4478),
    POI("peak_42", "Grand Combin",                 "peak", 45.93758,  7.29922, 4309),
    POI("peak_43", "Grandes Jorasses",             "peak", 45.86816,  6.98898, 4208),
    POI("peak_44", "Mont Blanc",                   "peak", 45.83271,  6.86517, 4806),
    POI("peak_45", "Grivola",                      "peak", 45.59600,  7.25744, 3969),
    POI("peak_46", "Gran Paradiso",                "peak", 45.51782,  7.26720, 4061),
    POI("peak_47", "Grande Casse",                 "peak", 45.40514,  6.82756, 3855),
    POI("peak_48", "Grand Roc Noir",               "peak", 45.33028,  6.89194, 3587),
    POI("peak_49", "Dent Parrachée",               "peak", 45.28909,  6.75608, 3697),
    POI("peak_50", "Pointe de Charbonnel",         "peak", 45.28047,  7.05568, 3752),
    POI("peak_51", "Pic de Rochebrune",            "peak", 44.82229,  6.78751, 3320),
    POI("peak_52", "La Meije",                     "peak", 45.00504,  6.30825, 3982),
    POI("peak_53", "Crête de Peyrolle",            "peak", 44.94240,  6.64390, 2618),  # approx, near Grande Peyrolle
    POI("peak_54", "Barre des Écrins",             "peak", 44.92216,  6.35955, 4102),
    POI("peak_55", "Monte Viso",                   "peak", 44.66744,  7.08999, 3841),
    POI("peak_56", "Mont Guillaume",               "peak", 44.58542,  6.43710, 2545),
    POI("peak_57", "Grand Bérard",                 "peak", 44.44973,  6.66027, 3046),
    POI("peak_58", "Dormillouse",                  "peak", 44.96559,  6.71314, 2510),
    POI("peak_59", "Chapeau de Gendarme",          "peak", 44.65000,  6.30000, 2682),  # not found on OSM
    POI("peak_60", "Les Trois Évêchés",            "peak", 44.28914, 6.53410, 2818),
    POI("peak_61", "Glandasse",                    "peak", 44.74189,  5.46343, 2041),
    POI("peak_62", "Merlu",                        "peak", 44.48777,  5.25752, 1540),
    POI("peak_63", "Pic de Bure",                  "peak", 44.62666,  5.93508, 2709),
    POI("peak_64", "Saint-Apôtre",                 "peak", 44.54085,  5.74450, 1491),
    POI("peak_65", "Montagne de Saint-Genis",      "peak", 44.39140,  5.83750, 1432),
    POI("peak_66", "Arambre",                      "peak", 44.43020,  5.74519, 1444),
    POI("peak_67", "Montagne de Chabre",           "peak", 44.26583, 5.64278, 1393),
    POI("peak_68", "Sommet de Bluye",              "peak", 44.23060,  5.25464, 1120),
    POI("peak_69", "Pic du Comte",                 "peak", 44.19779,  5.23966, 1154),
    POI("peak_70", "Mont Ventoux",                 "peak", 44.17396,  5.27840, 1909),
    POI("peak_71", "Montagne de Lure",             "peak", 44.12333, 5.80278, 1826),
    POI("peak_72", "Montagne de Jouère",           "peak", 44.27440,  6.10581, 1886),
    POI("peak_73", "Montagne de Gache",            "peak", 44.23391,  5.98769, 1357),
    POI("peak_74", "Blayeul",                      "peak", 44.24681,  6.31178, 2189),
    POI("peak_75", "Crête de Limans",              "peak", 44.08000,  5.83000, None),  # not found on OSM
    POI("peak_76", "Vachière",                     "peak", 44.15000,  6.10000, 2083),  # not found on OSM
    POI("peak_77", "Carton",                       "peak", 44.11407,  6.68163, 2123),
    POI("peak_78", "Cheval Blanc",                 "peak", 44.12701,  6.42381, 2323),
    POI("peak_79", "Serre de Montdenier",          "peak", 43.89788,  6.25498, 1750),
]
